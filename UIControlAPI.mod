		...
		<d2p1:anyType i:type="TableOfContents">
			...
			<Children>
				<d2p1:anyType i:type="BurnModInfo">
					<Dependencies />
					<Description>This is a Java-like API for the UI Control introduced by Relic. It should significantly reduce the time and effort required to create custom UI elements.</Description>
					<Hidden>false</Hidden>
					<Name>UI Control API</Name>
				</d2p1:anyType>
			</Children>
			<IsExpanded>true</IsExpanded>
		</d2p1:anyType>
